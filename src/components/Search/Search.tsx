...
// Use Effect hook to call fetchCities function => algolia places API
  useEffect(() => {
    if (!searchTerm) {
      return;
    }
  ...
  // Setting suggestions with useClickOutside func in ./hooks
  useClickOutside(suggestionRef, () => setShowSuggestions(false));

  const onSearchInputChanged = (e: any) => {
    setSearchTerm(e.target.value);
  };
  // calling fetchWeather set to lat/lng with open weather api

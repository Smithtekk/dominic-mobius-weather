...
// Exporting types for redux weatherReducer
...
// Setting inital state for weather
...
const weatherSlice = createSlice({
  ...
  initialState,
  reducers: {},
  // Using extraReducers to a callback that receives a object to define case reducers
